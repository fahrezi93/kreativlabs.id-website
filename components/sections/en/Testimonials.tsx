...
const testimonials = [
  {
    ...
    content: "KreativLabs.id is very professional in working on our company website. The results exceeded expectations!",
    rating: 5,
  ...
  },
  {
    ...
    content: "Modern and user-friendly website design. The team is very responsive and understands our business needs.",
    rating: 5,
    image: "/api/placeholder/80/80",
  },
  {
    ...
    content: "Outstanding work quality at competitive prices. Highly recommended!",
    rating: 5,
    image: "/api/placeholder/80/80",
  },
];

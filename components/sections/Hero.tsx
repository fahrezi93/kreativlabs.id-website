            ...
            <AnimatedSection animation="fade-up" duration={800}>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#3B82F6]/10 border border-[#3B82F6]/20 rounded-full mb-6 backdrop-blur-sm">
                ...
                <span className="text-xs text-white/90 font-medium whitespace-nowrap">
                  Website & Desain Grafis Profesional
                </span>
              </div>
            </AnimatedSection>
              ...
              <FadeInStagger index={0} delay={200}>
                <div className="group relative bg-[#0F1E37]/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-[#0F1E37]/80 hover:border-[#3B82F6]/50 transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    ...
                    <h3 className="text-white font-bold text-base mb-2 group-hover:text-[#3B82F6] transition-colors">Pengembangan Modern</h3>
                    <p className="text-white/70 text-sm leading-relaxed">Teknologi terkini untuk performa optimal</p>
                  </div>
                </div>
              </FadeInStagger>
              ...
              <FadeInStagger index={1} delay={200}>
                <div className="group relative bg-[#0F1E37]/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-[#0F1E37]/80 hover:border-[#3B82F6]/50 transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    ...
                    <h3 className="text-white font-bold text-base mb-2 group-hover:text-[#3B82F6] transition-colors">Desain Menarik</h3>
                    <p className="text-white/70 text-sm leading-relaxed">Desain grafis yang menarik dan profesional</p>
                  </div>
                </div>
              </FadeInStagger>
              ...
              <FadeInStagger index={2} delay={200}>
                <div className="group relative bg-[#0F1E37]/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-[#0F1E37]/80 hover:border-[#3B82F6]/50 transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    ...
                    <h3 className="text-white font-bold text-base mb-2 group-hover:text-[#3B82F6] transition-colors">Pengiriman Cepat</h3>
                    <p className="text-white/70 text-sm leading-relaxed">Pengerjaan cepat tanpa mengorbankan kualitas</p>
                  </div>
                </div>
              </FadeInStagger>
            </div>
